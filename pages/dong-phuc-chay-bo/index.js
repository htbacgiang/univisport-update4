...
const META_TITLE = 'Đồng Phục Chạy Bộ Cho CLB Và Giải Chạy | Vải Thoáng Nhẹ';
...
const META_KEYWORDS =
  'đồng phục chạy bộ, áo chạy bộ đồng phục, may đồng phục running, đồng phục giải chạy, Đồng Phục Univi';
const OG_IMAGE = 'https://dongphucunivi.com/images/banner-chay-bo.jpg';
const OG_IMAGE_ALT =
  'Đồng phục chạy bộ Univi cho CLB, đội nhóm và giải chạy';
    ...
    schema: [
      ...
      },
      {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 2, 'name': 'Đồng Phục Chạy Bộ', 'item': canonical },
        ],
      },
      ...(products.length > 0 ? [{
        '@context': 'https://schema.org',
...
export default function DongPhucChayBo({
  initialProducts,
  categoryCounts,
  gymCounts,
  enterpriseCounts,
  ...
  return (
    <CategoryPageTemplate
      ...
      ArticleComponent={RunningUniviPage}
